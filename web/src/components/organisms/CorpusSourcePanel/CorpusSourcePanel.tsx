...
import styles from './CorpusSourcePanel.module.css';

export interface CorpusSourcePanelProps {
...
export const CorpusSourcePanel: React.FC<CorpusSourcePanelProps> = ({ sources, isLoading, selectedId, onSelect, preprocessingCoverage }) => {
  return (
