...
export const contextStripDiagramWidget = defineWidget<ContextStripDiagramWidgetProps>({
  ...
  render: (props) => <ContextStripDiagram className={props.className} snapshot={props.snapshot} styleSet={props.styleSet} selectedPartId={props.selectedPartId} showLabels={props.showLabels} showSelection={props.showSelection} />,
});
